...
setup(
    ...
    packages=['pm4pyws', 'pm4pyws.util', 'pm4pyws.privacy', 'pm4pyws.privacy.roles', 'pm4pyws.handlers',
              'pm4pyws.handlers.xes', 'pm4pyws.handlers.xes.sna', 'pm4pyws.handlers.xes.ctmc',
              'pm4pyws.handlers.xes.cases', 'pm4pyws.handlers.xes.filtering', 'pm4pyws.handlers.xes.filtering.versions',
              'pm4pyws.handlers.xes.alignments', 'pm4pyws.handlers.xes.statistics',
              'pm4pyws.handlers.xes.process_schema', 'pm4pyws.handlers.xes.process_schema.tree',
              'pm4pyws.handlers.xes.process_schema.util', 'pm4pyws.handlers.xes.process_schema.dfg_freq',
              'pm4pyws.handlers.xes.process_schema.dfg_perf', 'pm4pyws.handlers.xes.process_schema.indbpmn_freq',
              'pm4pyws.handlers.xes.process_schema.indbpmn_perf', 'pm4pyws.handlers.xes.process_schema.inductive_freq',
              'pm4pyws.handlers.xes.process_schema.inductive_perf',
              'pm4pyws.handlers.xes.process_schema.heuristics_freq',
              'pm4pyws.handlers.xes.process_schema.heuristics_perf', 'pm4pyws.handlers.parquet',
              ...
              'pm4pyws.handlers.parquet.alignments', 'pm4pyws.handlers.parquet.statistics',
              'pm4pyws.handlers.parquet.process_schema', 'pm4pyws.handlers.parquet.process_schema.tree',
              'pm4pyws.handlers.parquet.process_schema.util', 'pm4pyws.handlers.parquet.process_schema.dfg_freq',
              'pm4pyws.handlers.parquet.process_schema.dfg_perf',
              'pm4pyws.handlers.parquet.process_schema.indbpmn_freq',
              'pm4pyws.handlers.parquet.process_schema.indbpmn_perf',
